...
namespace VersaValheimHacks.Options
{
    internal class BuffsOptions
    {
        ...
        /// expiry behavior: re-resting does not refresh rested. (Food cycling
        /// is gated by BetterEatingOptions.FoodCycling; the guardian-power
        /// no-cooldown switch lives in BetterPowersOptions.NoCooldown.)
        /// </summary>
